...
public class CadastrarCurriculoController implements Initializable{
    ...
    void aplicar(ActionEvent event) {
    	...
    	if(d != null && !ano_add.getSelectionModel().isEmpty() && !cargaHoraria_add.getText().isEmpty()){
            ...
            cd.setId(new CurriculoDisciplinaID(c.getId(), d.getCodDisciplina(), Integer.valueOf(cargaHoraria_add.getText()), ano));
    ...
    void initTables(){
    	...
    	col_cod.setCellFactory(new Callback<TableColumn<Curriculo,CurriculoID>, TableCell<Curriculo,CurriculoID>>() {

			@Override
			public TableCell<Curriculo, CurriculoID> call(TableColumn<Curriculo, CurriculoID> param) {
    	...
    	col_anoLetivo.setCellFactory(new Callback<TableColumn<Curriculo,CurriculoID>, TableCell<Curriculo,CurriculoID>>() {
    	...
    	col_cod2.setCellFactory(new Callback<TableColumn<Curriculo,CurriculoID>, TableCell<Curriculo,CurriculoID>>() {
    	...
    	col_anoLetivo2.setCellFactory(new Callback<TableColumn<Curriculo,CurriculoID>, TableCell<Curriculo,CurriculoID>>() {
    	...
    	table_curriculo2.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
			if (newSelection != null) {
				...
				for (CurriculoDisciplina curriculoDisc : oblist_disciplinasCur) {
					curriculoDisc.setNome(daoDisciplina.getDisciplina(curriculoDisc.getId().getCodDisciplina()).getNome());
				}
    	...
    	col_nomeDisciplina.setCellValueFactory(new PropertyValueFactory<>("nome"));
    	col_serieDisciplina.setCellValueFactory(new PropertyValueFactory<>("id"));

    	col_codDisciplina.setCellFactory(new Callback<TableColumn<CurriculoDisciplina,CurriculoDisciplinaID>, TableCell<CurriculoDisciplina,CurriculoDisciplinaID>>() {

			@Override
			public TableCell<CurriculoDisciplina, CurriculoDisciplinaID> call(TableColumn<CurriculoDisciplina, CurriculoDisciplinaID> param) {
    	...
    	col_serieDisciplina.setCellFactory(new Callback<TableColumn<CurriculoDisciplina,CurriculoDisciplinaID>, TableCell<CurriculoDisciplina,CurriculoDisciplinaID>>() {
