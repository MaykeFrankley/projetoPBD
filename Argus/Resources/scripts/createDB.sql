...
BEGIN 
	SELECT DISTINCT pessoas.codPessoa, pessoas.Nome, pessoas.Naturalidade, pessoas.Dt_nascimento, pessoas.CPF, Pessoas.Status
	FROM Pessoas
...
BEGIN 
	...
	FROM Pessoas
	INNER JOIN ResponsaveisFinanceiros
	WHERE Pessoas.codPessoa = ResponsaveisFinanceiros.codResponsavel;
END;$$
