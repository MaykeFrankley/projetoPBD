...
-- -----------------------------------------------------
-- Table `argus`.`matriculas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `argus`.`matriculas` (
  `codAluno` INT NOT NULL,
  `codTurma` INT NOT NULL,
...
-- -----------------------------------------------------
-- View `argus`.`viewMatricula`
-- -----------------------------------------------------
USE `argus`;
CREATE  OR REPLACE VIEW `viewMatricula` AS
SELECT pessoas.codPessoa as codAluno, pessoas.nome as aluno, curriculo.nome as curriculo, turmas.ano as serie, turmas.anoLetivo, matriculas.dt_matricula, matriculas.situacao
FROM pessoas, matriculas, turmas, curriculo
WHERE pessoas.codPessoa = matriculas.codAluno AND turmas.codTurma = matriculas.codTurma AND curriculo.codCurriculo = turmas.codCurriculo;
USE `argus`;
