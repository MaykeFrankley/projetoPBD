...
-- -----------------------------------------------------
-- Placeholder table for view `argus`.`ViewUsuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `argus`.`ViewUsuario` (`codPessoa` INT, `Nome` INT, `Naturalidade` INT, `Dt_nascimento` INT, `CPF` INT, `User` INT, `Senha` INT, `Tipo` INT, `Status` INT);

-- -----------------------------------------------------
-- Placeholder table for view `argus`.`ViewProfessor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `argus`.`ViewProfessor` (`codPessoa` INT, `Nome` INT, `Naturalidade` INT, `Dt_nascimento` INT, `CPF` INT, `Status` INT, `formacao` INT, `cursoFormacao` INT);

-- -----------------------------------------------------
-- View `argus`.`ViewUsuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `argus`.`ViewUsuario`;
USE `argus`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `argus`.`ViewProfessor`;
USE `argus`;
